...
import com.inagata.komunitaskelas.ui.fragment.ParentFragment;
...
public class MainActivity extends BenihActivity implements TabLayout.OnTabSelectedListener, AdapterView.OnItemSelectedListener
{
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ParentFragment homeFragment = (ParentFragment) ((MainPagerAdapter) viewPager.getAdapter()).getItem(0);
        switchFragment(homeFragment, position);
    }

    private void switchFragment(ParentFragment homeFragment, int position) {
        switch (position) {
            case 0:
                homeFragment.replace(R.id.fragment_home_container, new HomeFragment(), false);
                break;
            case 1:
                homeFragment.replace(R.id.fragment_home_container, new MessageFragment(), false);
                break;
            case 2:
                homeFragment.replace(R.id.fragment_home_container, new NotificationFragment(), false);
                break;
        }
    }
