...
JNIEXPORT void Java_in_co_madhur_chatlib_AndroidUtilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int radius) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_in_co_madhur_chatlib_AndroidUtilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jobject bitmap, int scale, int width, int height, int stride) {
